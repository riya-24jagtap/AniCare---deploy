...
INSERT IGNORE INTO `pet_records` VALUES (1,1,'Tommy','Dog','Labrador',3,NULL,1);
...
INSERT IGNORE INTO vet_appointments (vet_id, pet_id, appointment_time, reason, status)
...
INSERT IGNORE INTO ngo (id, name, latitude, longitude, location, email, role, password)
VALUES 
...
INSERT IGNORE INTO vet_appointments 
...
SELECT id, name, latitude, longitude FROM ngo;
UPDATE ngo
SET latitude = 19.07, longitude = 72.84
WHERE id = 18;

UPDATE ngo
SET location = 'Andheri West, Mumbai'
WHERE id = 18;

UPDATE ngo
SET location = 'Andheri West, Mumbai',
    address = 'StrayCare India, 47 Andheri West, Mumbai, Maharashtra, India'
WHERE id = 18;
...
SELECT id, vet_id, user_id, pet_name, appointment_date, appointment_time, status
FROM appointments
ORDER BY id DESC
LIMIT 5;
...
SELECT email FROM vets;
SELECT email FROM ngo;
...
UNION ALL
SELECT id, email, password FROM vets
UNION ALL
SELECT id, email, password FROM ngo;
