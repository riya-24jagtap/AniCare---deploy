...
INSERT IGNORE INTO `consultation_history` VALUES (2,8,1,'Fever and weakness','Antibiotics prescribed','2025-09-02','Follow-up in 5 days','2025-09-01 20:34:20');
...
INSERT IGNORE INTO `contact_messages` VALUES (1,'vet','Riya Test','riya@example.com','Test Subject','Testing contact page','2025-09-18 18:40:29'),(2,'ngo','Ruchi Suresh Jagtap','ruchijagtap.2023@gmail.com','collaboration','Request about collaboration with my PetPal NGO','2025-09-18 18:57:46'),(3,'user','Soham Suresh Jagtap','soham@example.com','collaboration','Wanted to enquire about the volunteer start date &  timings','2025-09-18 19:03:51'),(4,'vet','Aditi Suresh Jagtap','aditi@example.com','collaboration','Starting a new vet clinic at Bandra, thinking of collaborating with your organization','2025-09-18 19:17:55'),(6,'user','Riya Suresh Jagtap','riyajagtap.2023@gmail.com','general','hello world...','2025-09-19 05:47:45'),(7,'user','Jyoti Suresh Jagtap','jyoti@example.com','general','I have a question about my parrot and would appreciate some information on vaccine to be given.','2025-09-19 09:11:41');
...
INSERT IGNORE INTO `donations` VALUES (1,'Alice',1000,'2025-08-12','Keep up the great work!',3);
...
INSERT IGNORE INTO `feedback` VALUES (1,1,'This project shows genuine care for animals. Truly inspiring!','2025-09-18 21:47:45','Tejal Wagh ','tejal@example.com'),(2,NULL,'hello world \r\n','2025-09-19 05:48:44','Riya Suresh Jagtap','riyajagtap.2023@gmail.com'),(3,1,'Great webapp','2025-09-19 09:08:47','Kyle Drego','kyle@example.com');
...
INSERT IGNORE INTO `ngo` VALUES (17,'Bandra Animal Rescue','ngo','bandra.ngo@example.com','scrypt:32768:8:1$JQ68d51v$fcba2fbf78c5779156d94e04451ddcfc0fa30923ec10afcddf77d9e5bc368649899d119294a079f7c63f3a52d209f64b141aecf0af48d5acc9721d047f557bcb','+917390280068','Bandra Animal Rescue 123, Pali Hill Road, Opposite St. Peter\'s Church, Bandra West, Mumbai - 400050 Maharashtra, India','Bandra West, Mumbai','2025-09-16 02:27:00',NULL,NULL);
...
INSERT IGNORE INTO `pet_records` VALUES (1,1,'Tommy','Dog','Labrador',3,NULL,1,NULL);
...
INSERT IGNORE INTO `vet_appointments` VALUES (1,1,1,'2025-09-19 22:36:24','General Checkup','scheduled');
/*!40000 ALTER TABLE `vet_appointments` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `vet_consultations`
--
...
CREATE TABLE `vet_consultations` (
  ...
  PRIMARY KEY (`id`),
  KEY `vet_id` (`vet_id`),
  CONSTRAINT `vet_consultations_ibfk_1` FOREIGN KEY (`vet_id`) REFERENCES `vets` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `vet_consultations`
--

LOCK TABLES `vet_consultations` WRITE;
/*!40000 ALTER TABLE `vet_consultations` DISABLE KEYS */;
/*!40000 ALTER TABLE `vet_consultations` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2025-09-20  2:40:49
